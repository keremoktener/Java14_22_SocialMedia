...
public class JwtTokenManager {
    ...
    public Optional<String> createToken(Long id) {
        ...
        try {
            ...
            throw new UserProfileMicroServiceException(ErrorType.TOKEN_CREATION_FAILED);
        }
    ...
    public Optional<Long> getIdFromToken(String token) {
        try {
            ...
            throw new UserProfileMicroServiceException(ErrorType.INVALID_TOKEN_ARGUMENT);
        }
        catch (JWTVerificationException e) {
            throw new UserProfileMicroServiceException(ErrorType.TOKEN_VERIFICATION_FAILED);
        }
    }
